...
contract ArtistCreatorV2 is Initializable, UUPSUpgradeable, OwnableUpgradeable {
  ...
  function createArtist(
    ...
    // TODO: do we need to check for uniqness for created artist? Maybe not with above signing method
    ...
    //TODO: change ArtistV2 to Artist when done testing.
    BeaconProxy proxy = new BeaconProxy(
      beaconAddress,
      abi.encodeWithSelector(
        ArtistV2(address(0)).initialize.selector,
        msg.sender,
        _name,
        _symbol,
        _baseURI
  ...
  function getArtistContracts() public view returns (address[] memory) {
    return artistContracts;
  }
